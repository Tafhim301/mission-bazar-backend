...
router.post("/verify-password-otp", validateRequest(AuthValidation.verifyPasswordOtpSchema), AuthController.verifyPasswordOtp);
router.post("/set-new-password", validateRequest(AuthValidation.setNewPasswordSchema), AuthController.setNewPassword);
